...
export default function Leads() {
  ...
  const { statusConfigs } = useApi();
  const { roleConfigs } = useApi();

  const statusObj = useIDGetStatusesArray(statusConfigs.statuses);
  const rolesObj = useIDGetRolesArray(roleConfigs.roles);
